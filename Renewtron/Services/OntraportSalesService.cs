    ...
    public async Task ProcessEligibleRenewalsAsync()
    {
        ...
        foreach (var sale in eligibleSales)
        {
            ...
            try
            {
                ...
                // Create SearchLog and SearchResult for this ABN
                ...
                var searchResult = new SearchResult
                {
                    ...
                    AccountNumber = sale.Abn, // Will be updated if ASIC lookup provides different account number
                    RegistrationDate = sale.RenewalDueDate?.ToString("dd/MM/yyyy") ?? ""
                };

...
namespace Renewtron.Data.Migrations
{
    ...
    [Migration("20260403162102_AddOntraportSalesIntegration")]
    partial class AddOntraportSalesIntegration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Renewtron.Data.AirwallexPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Renewtron.Data.AirwallexPayment", b =>
                {
                    b.HasOne("Renewtron.Data.RenewalRequest", "RenewalRequest")
                        .WithOne("AirwallexPayment")
                        .HasForeignKey("Renewtron.Data.AirwallexPayment", "RenewalRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

...
namespace Renewtron.Migrations
{
    ...
    [Migration("20260925143716_ReaddAsicKeyRequestsForBrowser")]
    partial class ReaddAsicKeyRequestsForBrowser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Renewtron.Data.AsicKeyNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("OntraportContactIds")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<int>("OntraportContactsUpdated")
                        .HasColumnType("int");

                    b.Property<string>("PdfTextExcerpt")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.ToTable("AsicKeyNotifications");
                });

            modelBuilder.Entity("Renewtron.Data.AsicKeyRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("AsicKeyNotificationId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AsicReferenceNumber")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<bool>("CanAutoRetry")
                        .HasColumnType("bit");

                    b.Property<int>("CaptchaSolves")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("KeyReceivedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<Guid?>("OntraportSaleId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AsicKeyNotificationId");

                    b.HasIndex("BusinessName");

                    b.HasIndex("CreatedAt");

                    b.HasIndex("OntraportSaleId");

                    b.HasIndex("Status");

                    b.ToTable("AsicKeyRequests");
                });
            ...
            modelBuilder.Entity("Renewtron.Data.FunnelEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Renewtron.Data.OntraportSyncOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("NewRenewalDueDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("OntraportSyncOutbox");
                });

            modelBuilder.Entity("Renewtron.Data.OutboundMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Renewtron.Data.AsicKeyRequest", b =>
                {
                    b.HasOne("Renewtron.Data.AsicKeyNotification", "AsicKeyNotification")
                        .WithMany()
                        .HasForeignKey("AsicKeyNotificationId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Renewtron.Data.OntraportSale", "OntraportSale")
                        .WithMany()
                        .HasForeignKey("OntraportSaleId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("AsicKeyNotification");

                    b.Navigation("OntraportSale");
                });

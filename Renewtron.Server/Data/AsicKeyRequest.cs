...
/// submitted to ASIC's online enquiry form, then closed off when the key notification
/// shows up in the inbox. The row is the audit trail the admin sees end to end.
/// </summary>
public class AsicKeyRequest
{
    ...
    /// <summary>Captcha tokens bought across all attempts (each is billed).</summary>
